...
E_plane_full_wavelength = "E_plane_patch_array_full_wave.h5ant"
E_plane_half_wavelength = "E_plane_patch_array_half_wave.h5ant"
...
for i in range(9):
    ...
    print("E_field_max power for frequency " + str(Full_wavelength_data["frequencies"][i]) + "GHz: ", np.max(data_to_plot))
    plt.savefig("Pictures/Full_wavelength_E_plane_Normalised_Radiation_pattern_at_frequency_" + str(Full_wavelength_data["frequencies"][i]) + "GHz.png", dpi=300, bbox_inches='tight')
    #plt.show()
...
for i in range(9):
    ...
    ax.set_rlabel_position(90) 
    ax.set_rmin(-20)      # radial labels on the left
    print("E_field_max power for frequency " + str(half_wavelength_data["frequencies"][i]) + "GHz: ", np.max(data_to_plot))
    print()
    plt.savefig("Pictures/Half_wavelength_E_plane_Normalised_Radiation_pattern_at_frequency_" + str(half_wavelength_data["frequencies"][i]) + "GHz.png", dpi=300, bbox_inches='tight')
    #plt.show()
